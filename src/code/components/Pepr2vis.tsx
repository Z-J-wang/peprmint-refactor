...
export function Pepr2vis() {
  const { pdbid } = useParams<{ pdbid: string }>() // url with pdbid as parameter
  ...
  return (
    <Container>
      <PageHeader
        headerList={[PageHeaders.Home, PageHeaders.Pepr2vis]}
        title={title}
      ...
      <Row>
        <Col className="col-4">
          <InputArea
            ...
            setConvexHullKey={setconvexHullKey}
            setRecalculateKey={setRecalculateKey}
          />
          <ControlArea
            checkedKeys={checkedKeys}
            setCheckedKeys={setCheckedKeys}
            convexHullKey={convexHullKey}
            setConvexHullKey={setconvexHullKey}
            recalculateKey={recalculateKey}
            setRecalculateKey={setRecalculateKey}
          />
        </Col>
        <Col className="pt-4">
          {' '}
          <div id="molstar-div" style={{ height: 685 }} />{' '}
        </Col>
      </Row>
