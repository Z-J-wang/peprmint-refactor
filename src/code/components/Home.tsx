  ...
  render() {
    return (
      <>
        ...
        <Row className="justify-content-md-center mb-3">
          <Space size="large">
            <Button className="text-white" type="link" href="#learn-more">
              Learn more
            </Button>
            <span>
              <a href="https://github.com/reuter-group/peprmint-web" title="Source code repository">
      ...
      <Container>
        ...
        <Row className="justify-content-md-center">
          ...
          <ModuleCard
            title={
              <span className="text-primary h5">
                PePr<sup>2</sup>DS<sup className="text-muted">BETA</sup>
              </span>
            }
            link={'/pepr2ds'}
            imgSrc={Pepr2dsPic}
        ...
        <Carousel>
          <Carousel.Item>
            ...
            <Carousel.Caption>
              ...
              <p>
                {' '}
                Descriptions here... (How to use your own figure here: just replace the picture file 'ExamplePic.png',
                and check if its size fits the webpage well.) Tips: if you have text on your image, then just leave this
                paragraph empty
              </p>
            </Carousel.Caption>
          </Carousel.Item>
