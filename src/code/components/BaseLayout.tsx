...
export function HeaderTheme1() {
  // single mint color style
  return (
...
const headerTheme2 = // multiple colors
  (
    <h5 className="font-weight-normal">
      {' '}
      Resources for
      <span className="font-weight-bold" style={{ color: '#1C75BB' }}>
        {' '}
        Pe
      </span>
      ripheral
        ...
        <Navbar>
          <Col className="col-3">
            <Nav className="flex-column">
              ...
              <Nav.Link className="py-0 font-weight-light" href="https://github.com/reuter-group/peprmint-web">
                {' '}
                Version 1.3{' '}
              </Nav.Link>
              <Nav.Link className="py-0 font-weight-light" href="http://www.cbu.uib.no/reuter/">
                {' '}
                &copy; 2021-2022 Reuter Lab{' '}
              </Nav.Link>
            </Nav>
          </Col>
          <Col className="col-4">
            <Nav className="flex-column">
              ...
              <Nav.Link
                className="py-0 font-weight-light"
                href="mailto:Thibault.Tubiana@uib.no"
                title="Send an email to this contact"
              >
                {' '}
                Thibault Tubiana, researcher{' '}
              </Nav.Link>
              <Nav.Link
                className="py-0 font-weight-light"
                href="mailto:dandan.xue@uib.no"
                title="Send an email to this contact"
              >
                {' '}
                Dandan Xue, engineer{' '}
              ...
              <Nav.Link
                className="py-0 font-weight-light"
                href="mailto:Nathalie.Reuter@uib.no"
                title="Send an email to this contact"
              >
                Nathalie Reuter, Prof./Group leader{' '}
              </Nav.Link>
            </Nav>
          </Col>
          ...
          <Col className="col-2 text-center">
            {' '}
            <a href="http://www.cbu.uib.no/">
              <Image src={CbuLogo} width={110} />{' '}
            </a>{' '}
          </Col>
  ...
  return (
    <Router>
      <Container fluid className="px-0 py-0">
        <Switch>
          <Route path="/pepr2vis/:pdbid">
            {' '}
            <Header /> <Pepr2vis />{' '}
          </Route>
          <Route exact path="/pepr2vis">
            {' '}
            <Header /> <Pepr2vis />{' '}
          </Route>
          <Route exact path="/pepr2ds">
            {' '}
            <Header /> <Pepr2ds />{' '}
          </Route>
          <Route exact path="/">
